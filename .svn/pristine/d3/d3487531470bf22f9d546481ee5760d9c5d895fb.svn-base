...
public final class SystemUtil {
	...
	// 各种产品点击链接点击事件
	public static void proItemOnClickListener(int linkType, String linkUrl, String titleName, String imgUrl) {
		Bundle bundle = new Bundle();
		if (linkType == 2) {
			bundle.putString(ArgName.ProductDetail.URL, linkUrl);
			bundle.putString(ArgName.ProductDetail.TITLE, titleName);
			bundle.putString(ArgName.ProductDetail.PIC_URL, imgUrl);
			ChangeFragmentUtil.changeFragment(ChangeFragmentUtil.PRODUCT_DETAIL, bundle);
		} else if (linkType == 3) {
			HashMap<String, String> param = new HashMap<String, String>();
			param.put("targetpage", "1");
			bundle.putString(ArgName.ProductList.URL, linkUrl);
			bundle.putString(ArgName.ProductList.TITLE, titleName);
			...
			bundle.putString(ArgName.Web.URL, linkUrl);
			ChangeFragmentUtil.changeFragment(ChangeFragmentUtil.HOME_WEB, bundle);
		} else if (linkType == 5) {
			HashMap<String, String> param = new HashMap<String, String>();
			param.put("targetpage", "1");
			bundle.putString(ArgName.ProductList.URL, linkUrl);
			bundle.putString(ArgName.ProductList.TITLE, titleName);
			bundle.putBoolean(ArgName.ProductList.SHOW_SORT, true);
			bundle.putSerializable(ArgName.ProductList.PARAM, param);
			ChangeFragmentUtil.changeFragment(ChangeFragmentUtil.PRODUCT_LIST, bundle);
		}
	}
